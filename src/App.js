import './App.css';
import { Flex, Button, Center, Input, Slider, Text, SliderTrack, SliderFilledTrack, SliderThumb, Card, SimpleGrid, Select, useColorMode, IconButton, Icon } from '@chakra-ui/react';
